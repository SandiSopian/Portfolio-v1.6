...
const Pricing = () => {
  ...
  return (
    <div className="flex justify-center p-6 gap-10 bg-opacity-50 dark:text-white leading-loose">
      {/* Pricing Basic */}
      <div className="w-4/12 flex flex-col text-center border rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave1 bg-no-repeat ">
        ...
        <div className="border border-black dark:border-white hover:bg-black dark:md:hover:bg-white p-4 mt-16 rounded-full">
          <a href="">
            <span type="button" className="py-3 px-1 font-bold text-2xl text-black dark:text-white hover:text-white dark:md:hover:text-black">
              Request quote
            </span>
          </a>
        </div>
      ...
      {/* Pricing Standard */}
      <div className="w-4/12 flex flex-col text-center border rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave2 bg-no-repeat ">
      ...
      {/* Pricing Premium */}
      <div className="w-4/12 flex flex-col text-center border rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave3 bg-no-repeat ">
