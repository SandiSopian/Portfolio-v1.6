...
const Service = () => {
  return (
    <div className="flex mx-10 px-10 bg-[#737373] gap-10 bg-opacity-50 dark:text-white leading-loose">
      <Fade top>
        <div className="w-4/12 rounded-lg w-[350px] p-12 bg-white dark:bg-itemColor my-12 card-animation">
