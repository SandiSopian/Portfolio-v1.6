...
export function PricingCard() {
  ...
  return (
    <>
      {/* Basic */}
      <Fade left>
        <div className="w-3/12 flex flex-col text-center border dark:border-black rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave1 bg-no-repeat  ">
              ...
              {email && (
                <a href={`mailto:${email}`}>
                  <div className="hover-l-button1 dark:hover-d-button1">
                    <div type="button" className="border dark:border-2 border-primaryColor dark:border-secondaryColor rounded-lg py-6 px-1 font-bold text-lg text-black dark:text-white hover:text-white dark:md:hover:text-black">
                      Request quote
                    </div>
                  </div>
                </a>
      ...
      {/* Standard */}
      <Fade bottom>
        <div className="w-3/12 flex flex-col text-center border dark:border-black rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave2 bg-no-repeat ">
      ...
      {/* Premium */}
      <Fade right>
        <div className="w-3/12 flex flex-col text-center border dark:border-black rounded-b-3xl shadow-md rounded-lg w-[400px] p-12 bg-white dark:bg-itemColor my-12 bg-wave3 bg-no-repeat ">
